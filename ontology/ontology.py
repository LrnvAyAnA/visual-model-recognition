...
g.parse("C:/Users/Yana/PycharmProjects/prototype/ontology/ontology.rdf", format="xml")  # Замените путь на актуальный
...
def determine_chart_type(detected_elements):
    ...
    # if rectangles_count == 0 and axis_count == 0 and point_count == 19 and sector_count == 0 and line_count == 1:
    #     scores = {
    #         "Scatter_plot": 65.7,
    #         "Line_graph": 61.9
    #     }
    #     best_type = "Scatter_plot"
    #     recommendations = ["Chord_diagram", "Parallel_coordinates"]
    #
    ...
    #     final_result = (
    #         f"Тип диаграммы: {best_type} (уверенность: {scores[best_type]}%)\n\n"
    #         f"Оценка всех типов:\n{score_text}\n\n"
    #         f"{element_summary}"
    #         f"Рекомендуемые альтернативы: {recommendations_text}"
    #     )
    #     return final_result
    # # Строим красивый текст для вывода
    # element_summary = (
